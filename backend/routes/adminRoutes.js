...
// POST /api/admin/subjects - Create or update subjects for a class
router.post('/subjects', verifyAdminToken, createOrUpdateSubjects);

// GET /api/admin/subjects - Get all subjects with filters
router.get('/subjects', verifyAdminToken, getAdminSubjects);
...
// DELETE /api/admin/subjects/:id - Delete subjects for a class
router.delete('/subjects/:id', verifyAdminToken, deleteSubjects);
